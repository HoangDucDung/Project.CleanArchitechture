...
namespace Project.Host.Base.Factories
{
    public static class APIDocumentFactorys
    {
        public static IServiceCollection AddAPIDocument(this IServiceCollection services, string filePath)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1",
                    ...
                    {
                        Title = $"{filePath} Documentation",
                        Version = "v1",
                        Description = "Tài liệu tích hợp authen",
        ...
        {
            // Vẫn tạo JSON Swagger nhưng KHÔNG khởi chạy SwaggerUI
            app.UseSwagger();

            // Cấu hình ReDoc làm mặc định
            app.UseReDoc(c =>
            {
                c.RoutePrefix = "auth"; // Đặt làm route mặc định
